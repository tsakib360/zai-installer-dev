...
<div class="section-wrap-body">
    ...
    <div class="primary-form">
      <form action="{{ route('ZaiInstaller::final') }}" method="POST">
        ...
        {{-- <div class="single-section">
          <h4 class="section-title">Please enter your Account details for administration</h4>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="FirstName">First Name</label>
                <input type="text" class="form-control" id="FirstName" name="FirstName" placeholder="example" />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="Lastname">Last name</label>
                <input type="text" class="form-control" id="Lastname" name="Lastname" placeholder="example" />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="Email">Email</label>
                <input type="email" class="form-control" id="Email" name="Email" placeholder="demo@example.com" />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
